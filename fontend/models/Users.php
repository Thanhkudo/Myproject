...
class Users extends Model {
    ...
    public function insert(){
        $insert=$this->conn->prepare("INSERT INTO users(`username`,`password`,`fullname`,`phone`,`address`,`email`,`gender`,`vip`) 
        VALUES (:username,:password,:fullname,:phone,:address,:email,:gender,:vip)");
        $arr_insert=[
